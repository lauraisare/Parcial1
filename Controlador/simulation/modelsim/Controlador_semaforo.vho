...
-- carril_cerrado	=>  Location: PIN_C8,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Controlador_semaforo IS
...
SIGNAL \ALT_INV_carril_cerrado~input_o\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\ALT_INV_carril_cerrado~input_o\ <= NOT \carril_cerrado~input_o\;
...
-- pragma translate_on
PORT MAP (
	i => \ALT_INV_carril_cerrado~input_o\,
	devoe => ww_devoe,
